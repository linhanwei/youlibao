...
//	protected $fields = array();
        ...
        //数据表
        protected $trueTableName = 'deliver_goods'; 
...
//	);
         ...
         * $cache 缓存设置
         */
        public function getDetail($where=array(),$field=array('field'=>array(),'is_opposite'=>false),$cache=array('key'=>false,'expire'=>null,'cache_type'=>null),$order=''){
            if($cache === TRUE){
